...
export const SelectTrigger = ({
  ...
  <SelectPrimitive.Trigger
    ...
    className={cn(
      "border-input bg-background text-foreground focus:ring-ring/50 flex h-9 w-full items-center justify-between gap-2 rounded-md border px-3 py-2 text-sm shadow-xs transition-colors outline-none focus:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className,
    )}
    {...props}
  >

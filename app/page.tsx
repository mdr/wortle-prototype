        ...
        <div className="space-y-6">
          ...
          <Card className="p-6">
            ...
            <p className="text-muted-foreground">
              Select a puzzle below to see how it might work:
            </p>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                ...
                photographs give sufficient detail to unambiguously identify the species, and to help give correct
                and useful ID tips to players.
              </p>
              <p>
